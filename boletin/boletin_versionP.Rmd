...
tabla_paginada[[i]] <- tabla_paginada[[i]] %>% gt(rowname_col="Clase",groupname_col = "") %>% cols_width(
    DESCRIPCIONDOMINIOEMMET39 ~ pct(13),
    varprod_plot ~  pct(6),
    ...
    everything() ~ pct(10)
                     ...
                     personal =md("**Contribución<br>Personas**")) %>% tab_options(table.font.size=7,table.width = pct(65),table.layout="fixed") %>% tab_style(style=cell_text(color="white"),locations=cells_body(rows=varprod==0.001))
...
knitr::include_graphics(paste0("tabla1_", 3, ".png"),dpi=200)
```
...
knitr::include_graphics(paste0("tabla2_", 3, ".png"),dpi=200)
```
...
knitr::include_graphics(paste0("tabla3_", 3, ".png"),dpi=200)
```
...
tabla_paginada[[i]] <- tabla_paginada[[i]] %>% gt(rowname_col="Clase",groupname_col = "") %>% cols_width(
    ...
    everything() ~ pct(10)
                     ...
                     varpersonas_plot ="",
                     varpersonas =md("**Variación<br>Personas**"),
                     personal =md("**Contribución<br>Personas**")) %>% tab_options(table.font.size=8,table.width = pct(50),table.layout="fixed") %>% tab_style(style=cell_text(color="white"),locations=cells_body(rows=varprod==0.001))
...
knitr::include_graphics(paste0("tabla13_", 3, ".png"),dpi=200)
```
