...
#instalar todas las librerias necesarias para el proceso
  ...
  librerias <- c("tidyverse", "ggplot2", "dplyr","readr","readxl","stringr","tidyr","lubridate","forecast","tsoutliers","data.table","VIM","scales","kableExtra","formattable","htmltools","webshot","openxlsx","seasonal","xlsx","rmarkdown","roxygen2","plotly","gt","purrr","knitr","tinytex","webshot2","installr")
